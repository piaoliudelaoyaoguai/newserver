...
$(function(){
	...
	$('#DataTables_table_paginate .paginate_button').on( 'click', function () {
		...
		window.location.href = program+"/redpacket/redpacket-list-page.html?"+requrl+"pageNo="+val;
		/*window.location.href = program+"/redpacket/redpacket-list-page.html?pageNo="+val+"&user_id="+user_id;*/
	});
})
