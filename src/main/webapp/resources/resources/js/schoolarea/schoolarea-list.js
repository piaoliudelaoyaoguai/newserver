...
$(function(){
	...
	$('#DataTables_table_paginate .paginate_button').on( 'click', function () {
		...
		/*window.location.href = "schoolarea-list-page.html?"+requrl+"pageNo="+val;*/
		window.location.href = "schoolarea-list-page.html?pageNo="+val+"&flag="+flag+"&pid="+pid;
	});
})
...
function add_info(title,url,w,h,pageNo,flag,pid){
	layer_show_max(title,url+"?pageNo="+pageNo+"&flag="+flag+"&pid="+pid,w,h);
}

function del_info(id,pageNo){
	layer.confirm('确认要删除吗？',function(index){
		window.location.href = "schoolarea-delete.html?pageNo="+pageNo+"&id="+id+"&flag="+flag+"&pid="+pid;
	});
}
...
function datadel(pageNo){
	...
	layer.confirm('确认要删除这些信息吗？',function(index){
		window.location.href = "schoolarea-deletes.html?pageNo="+pageNo+"&ids="+ids+"&flag="+flag+"&pid="+pid;
	});
}
