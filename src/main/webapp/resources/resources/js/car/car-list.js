$(function(){
	...
	$('#DataTables_table_paginate .paginate_button').on( 'click', function () {
		...
		window.location.href = "car-list-page.html?"+requrl+"pageNo="+val;
	});
})
...
function back_info(id,pageNo){
	layer.confirm('确认要归还吗？',function(index){
		window.location.href = "car-back.html?pageNo="+pageNo+"&id="+id;
	});
}

function del_info(id,pageNo){
	layer.confirm('确认要删除吗？',function(index){
		window.location.href = "car-delete.html?pageNo="+pageNo+"&id="+id;
	});
}
