$(function(){
	...
	$('#DataTables_table_paginate .paginate_button').on( 'click', function () {
		...
		window.location.href = "martgoods-list-page6.html?"+requrl+"pageNo="+val;
	});
})
...
function del_info(id,pageNo,flag){
	layer.confirm('确认要删除吗？',function(index){
		window.location.href = "martgoods-deltejia-huodong.html?pageNo="+pageNo+"&id="+id+"&flag="+flag;
	});
}
...
function datadel(pageNo,flag){
	...
	layer.confirm('确认要删除这些信息吗？',function(index){
		window.location.href = "martgoods-deltejia-huodongs.html?pageNo="+pageNo+"&ids="+ids+"&flag="+flag;
	});
}
