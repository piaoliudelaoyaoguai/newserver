$(function(){
	...
	$('#DataTables_table_paginate .paginate_button').on( 'click', function () {
		...
		//window.location.href = "power-list-page.html?"+requrl+"pageNo="+val;
		window.location.href = "power-list-page.html?"+"pageNo="+val;
	});
})
...
function back_info(id,pageNo){
	layer.confirm('确认要归还吗？',function(index){
		window.location.href = "power-back.html?pageNo="+pageNo+"&id="+id;
	});
}

function del_info(id,pageNo){
	layer.confirm('确认要删除吗？',function(index){
		window.location.href = "power-delete.html?pageNo="+pageNo+"&id="+id;
	});
}
