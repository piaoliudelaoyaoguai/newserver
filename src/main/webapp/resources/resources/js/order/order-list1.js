$(function(){
	...
	$('#DataTables_table_paginate .paginate_button').on( 'click', function () {
		...
		/*window.location.href = "order-list-page.html?"+requrl+"pageNo="+val+"&mark=a";*/
...
function off_info(orderno,pageNo,mark){
	layer.confirm('确认要取消此订单吗？',function(index){
		window.location.href = "order-offorder.html?pageNo="+pageNo+"&orderno="+orderno+"&mark="+mark;
	});
}
