...
function getskincookie(){
	...
	$("#skin").attr("href","resources/skin/"+v+"/skin.css");// 修改日期2015年12月9日10:48:35
}
$(function(){
	getskincookie();
	...
	/*左侧菜单*/
	$.Huifold(".menu_dropdown dl dt",".menu_dropdown dl dd","fast",1,"click","selected");
	$.Huifold(".Hui-aside .menu_dropdown .menu_two .menu_two_dt",".Hui-aside .menu_dropdown .menu_two .menu_two_dd","fast",1,"click","two_show_selected");
	/*选项卡导航*/
